// servers/home/libs/utils/Junker.js
// Many thanks to GitHub user smolgumball for providing this!
var argsSchema = [["host", "home"]];
...
Junker used these filters to queue these files for deletion:

Filters:
  > Starts with: ${startsWith || "home/hacks"}
  > Ends with: ${endsWith || "[PLEASE SET ME]"}
  > Host: ${options.host || "[PLEASE SET ME | DEFAULTS TO HOME]"}
